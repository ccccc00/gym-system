...
public interface AdminMapper {
    ...
    List<Gms_Vip> queryVipList(int index, int currentCount, String query_key);
    ...
    Integer getVipTotalCountByKeyQuery(String query_key);
    void updateVip(Gms_Vip gms_vip);
    void addVip(Gms_Vip gms_vip);
    void delVip(Gms_Vip gms_vip);
    void updatefVip(Gms_Vip gms_vip);
    Integer searchVip(Gms_Vip gms_vip);
}
