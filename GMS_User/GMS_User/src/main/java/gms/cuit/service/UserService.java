...
//        mailService.sendHTMLMail(dto);
    ...
    public Gms_Inschool getSchool(){
        String schoolphone = SecurityContextHolder.getContext().getAuthentication().getName();
        Gms_Inschool student = userMapper.finStuById(schoolphone);
        return student;
    }
